            ...
            <div class="col-md-12">
                <form action="/final_project/public/user/profile/{{ $User->id }}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="password" placeholder="your new password" value="{{old('password', $User->password_confirmation)}}">
                    </div>

                    <div class="form-group">
                        <label>Password Comfirmation:</label>
                        <input class="form-control" type="password" name="password_confirmation" placeholder="confirm your password" value="{{old('password_confirmation', $User->password_confirmation)}}">
                    </div>
